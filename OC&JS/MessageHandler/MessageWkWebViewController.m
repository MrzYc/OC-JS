...
@interface MessageWkWebViewController () <WKUIDelegate, WKScriptMessageHandler>
...
@implementation MessageWkWebViewController
...
- (void)initWKWebView {
    ...
    NSString *urlStr = [[NSBundle mainBundle] pathForResource:@"message.html" ofType:nil];
...
- (void)getLocation {
    ...
    // 将结果返回给js
    NSString *jsStr = [NSString stringWithFormat:@"setLocation('%@')",@"上海东方明珠电视台"];
...
- (void)shakeAction
{
    ...
    [YCAudioPlayer playMusic:@"shake_sound_male.wav"];
}
...
- (void)playSound:(NSString *)fileName
{
    ...
    [YCAudioPlayer playMusic:fileName];
}
