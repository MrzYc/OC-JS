...
@interface BridgeWkWebViewController ()<WKNavigationDelegate, WKUIDelegate>
...
@implementation BridgeWkWebViewController
...
- (void)initWKWebView {
    ...
    NSString *urlStr = [[NSBundle mainBundle] pathForResource:@"bridge.html" ofType:nil];
