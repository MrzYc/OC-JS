...
@interface BridgeWebViewController ()<UIWebViewDelegate>
...
- (void)viewDidLoad {
    ...
    NSURL *htmlURL = [[NSBundle mainBundle] URLForResource:@"bridge.html" withExtension:nil];
