...
- (void)initWKWebView {
    ...
    NSString *urlStr = [[NSBundle mainBundle] pathForResource:@"indexURL.html" ofType:nil];
...
- (void)getLocation
{
    // 获取位置信息
    // 将结果返回给js
    NSString *jsStr = [NSString stringWithFormat:@"setLocation('%@')",@"上海外滩东方明珠"];
